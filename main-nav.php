...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    		<ul id="nav-list" class="">
    			...
    			<li><a href="empresas.php#que-es" onclick="closeNav()"><?php if($lang=='en'){ ?>WHAT’S BURN TO GIVE?<?php }else{ ?>¿qué es burn to give?<?php } ?></a></li>

    			<li class="odd"><a href="empresas.php#como" onclick="closeNav()"><?php if($lang=='en'){ ?>HOW TO JOIN AND HELP?<?php }else{ ?>Cómo ayudar<?php } ?></a></li>

    			<li><a href="empresas.php#historia" onclick="closeNav()"><?php if($lang=='en'){ ?>OUR STORY<?php }else{ ?>historia<?php } ?></a></li>
